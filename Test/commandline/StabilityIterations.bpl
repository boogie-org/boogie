// RUN: %parallel-boogie -randomSeed:0 -vcsStabilityIterations:2 -xml:"%t-1.xml" "%s"
...
// CHECK:     \<assertion file="StabilityIterations.bpl" line="33" column="3" /\>
...
// CHECK:     \<assertion file="StabilityIterations.bpl" line="35" column="3" /\>
// CHECK:     \<conclusion duration=".*" outcome="valid" resourceCount=".*" /\>
// CHECK:   \</assertionBatch\>
