...
// The interval domain (-infer:j) used to ask float literals for integer bounds, and crashed on floats
// whose exponent makes those bounds huge. It asks no longer, but a wide format still has to come through
...
// A small value in a wide format, whose bounds were the ones small enough to compute
