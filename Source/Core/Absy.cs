...
namespace Microsoft.Boogie
{
  ...
  public class Program : Absy
  {
    ...
    private void AddToFullMap(Dictionary<string, Dictionary<string, Block>> fullMap, string procName, string blockName,
      Block block)
    {
    ...
    public Dictionary<string, Dictionary<string, Block>> ExtractLoops(out HashSet<string> procsWithIrreducibleLoops)
    {
      ...
      List<Implementation /*!*/> /*!*/
        loopImpls = new List<Implementation /*!*/>();
  ...
  public class DatatypeSelector : Function
  {
    ...
    public DatatypeSelector(Function constructor, int index)
      : base(constructor.InParams[index].tok,
        ...
        new List<Variable>
        {
          new Formal(constructor.tok, new TypedIdent(constructor.tok, "", constructor.OutParams[0].TypedIdent.Type),
            true)
        },
        new Formal(constructor.tok, new TypedIdent(constructor.tok, "", constructor.InParams[index].TypedIdent.Type),
          false))
    {
