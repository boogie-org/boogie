...
namespace Microsoft.Boogie
{
  ...
  public class CallCounterexample : Counterexample
  {
    ...
    public override Counterexample Clone()
    {
      var ret = new CallCounterexample(options, Trace, AugmentedTrace, UnderlyingAssert, Model, MvInfo, Context, Checksum);
      ret.calleeCounterexamples = calleeCounterexamples;
      return ret;
    }
  }
  ...
  public class ReturnCounterexample : Counterexample
  {
    ...
    public override Counterexample Clone()
    {
      var ret = new ReturnCounterexample(options, Trace, AugmentedTrace, UnderlyingAssert, FailingReturn, Model, MvInfo, Context, checksum);
      ret.calleeCounterexamples = calleeCounterexamples;
      return ret;
    }
  }
