...
namespace Microsoft.Boogie.VCExprAST
{
  public struct FlattenerState
  {
    ...
    public FlattenerState TogglePolarity
    {
      get { return new FlattenerState(-Polarity, InTerm); }
    }

    public FlattenerState ZeroPolarity
    {
      get { return new FlattenerState(0, InTerm); }
    }

    public FlattenerState EnterTerm
    {
      get { return new FlattenerState(Polarity, true); }
    }
  }
  ...
  public class TermFormulaFlattener : MutatingVCExprVisitor<FlattenerState>
  {
    ...
    private readonly IDictionary<VCExpr /*!*/, VCExprVar /*!*/> /*!*/
      Bindings =
    ...
    public VCExpr Flatten(VCExpr expr)
    {
      ...
      VCExpr /*!*/
        res = Mutate(expr, FlattenerState.INITIAL);
      Contract.Assert(res != null);
      while (Bindings.Count > 0)
      {
        List<VCExprLetBinding /*!*/> /*!*/
          letBindings = new List<VCExprLetBinding /*!*/>();
    ...
    private List<VCExprLetBinding /*!*/> /*!*/ RemoveBindingsWithVars(List<VCExprVar /*!*/> /*!*/ boundVars,
    ...
    private VCExpr AddBindings(List<VCExprLetBinding /*!*/> /*!*/ bindings, VCExpr body, FlattenerState state)
    {
      ...
      List<VCExprLetBinding /*!*/> /*!*/
        mutatedBindings = FlattenBindings(bindings, state);
      Contract.Assert(mutatedBindings != null);
      VCExpr /*!*/
        bindingEquations = Gen.AsEquations(mutatedBindings);
    ...
    private List<VCExprLetBinding /*!*/> /*!*/
      FlattenBindings(List<VCExprLetBinding /*!*/> /*!*/ bindings, FlattenerState state)
    {
      Contract.Requires(cce.NonNullElements(bindings));
      Contract.Ensures(cce.NonNullElements(Contract.Result<List<VCExprLetBinding>>()));
      FlattenerState stateInBindings = state.ZeroPolarity;
      List<VCExprLetBinding /*!*/> /*!*/
        mutatedBindings = new List<VCExprLetBinding /*!*/>();
